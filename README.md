...
A native Android version is included in `android-app/` with:
- Supabase sign-in (email/password)
- My Day task list + archive
- Home-screen My Day widget (tap to toggle task completion)

See `android-app/README.md` for setup and build instructions.
